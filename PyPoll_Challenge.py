...
with open(file_to_save, "w") as txt_file:
    ...
    # 7: Print the county with the largest turnout to the terminal.
            ...
            largest_county_summary = (f"{largest_county_name} had the highest turnout with {largest_county_votes} total votes and {winning_county_percentage:.1f}% of the total vote.\n"f"-------------------------\n")
